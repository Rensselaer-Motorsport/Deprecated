...
#if (I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1)
    #define I2C_MPU6050_FF_DATA_NR_LOG2_PLUS1_MASK (0x0Fu) /* FF_DATA_NR_LOG2_PLUS1 = 4, MASK = 2^4 - 1 = 15 */
    #define I2C_MPU6050_FF_DATA_NR_LOG2_MASK       (0x07u) /* FF_DATA_NR_LOG2 = 3, MASK = 2^3 - 1 = 7 */
#else
    #define I2C_MPU6050_FF_DATA_NR_LOG2_PLUS1_MASK (0x1Fu) /* FF_DATA_NR_LOG2_PLUS1 = 5, MASK = 2^5 - 1 = 31 */
    #define I2C_MPU6050_FF_DATA_NR_LOG2_MASK       (0x0Fu) /* FF_DATA_NR_LOG2 = 4, MASK = 2^4 - 1 = 15 */
#endif /* (I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1) */
...
#define I2C_MPU6050_SPI_CTRL_LATE_MISO_SAMPLE      ((uint32) 0x01u << \
    ...
    #define I2C_MPU6050_SPI_CTRL_SSEL0_POLARITY   ((uint32) 0x01u << I2C_MPU6050_SPI_CTRL_SSEL_POLARITY0_POS)
    #define I2C_MPU6050_SPI_CTRL_SSEL1_POLARITY   ((uint32) 0x01u << I2C_MPU6050_SPI_CTRL_SSEL_POLARITY1_POS)
    #define I2C_MPU6050_SPI_CTRL_SSEL2_POLARITY   ((uint32) 0x01u << I2C_MPU6050_SPI_CTRL_SSEL_POLARITY2_POS)
    #define I2C_MPU6050_SPI_CTRL_SSEL3_POLARITY   ((uint32) 0x01u << I2C_MPU6050_SPI_CTRL_SSEL_POLARITY3_POS)
